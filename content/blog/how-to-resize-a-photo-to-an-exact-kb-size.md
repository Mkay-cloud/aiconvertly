...
2. Upload your photo. It accepts JPEG, PNG, or WebP. ![uploading a photo to the Compress Image to KB tool](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-01.svg)
3. Pick a preset target size, common ones are 240 KB (US DS-160), 120 KB (several EU visa services), 100 KB, 50 KB, or 20 KB (common on Indian government forms), or type your own custom number if your form's limit falls somewhere else. ![the target size presets, with a custom KB value entered](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-02.svg)
4. Run the compression. It's not just one quality pass. The tool runs a binary search: it tries a quality level, checks how big the result is, and keeps adjusting up or down until it lands under your target. If your target is very small, like 20 KB, and quality reduction alone can't reach it, it'll shrink the pixel dimensions too. ![the tool finishing, showing the resulting file size next to your target](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-03.svg)
5. Download the result, then open its properties in File Explorer or Finder and confirm the actual size matches before you upload it to the actual form. ![the downloaded file's size shown in File Explorer or Finder](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-04.svg)

### Imagera's Compress Image tool

1. Go to imagera.ai and open the free **Compress Image** tool.
2. Pick a JPG, PNG, or WebP photo from your device (on a phone, this also accepts HEIC straight from the camera roll). ![picking a photo file in Imagera's compress tool](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-05.svg)
3. Type the exact size you want into the target field, for example 100 KB. ![typing a target KB value into the size field](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-06.svg)
4. Choose your output format. JPG is the safest default for a photo like this. ![the output format selector set to JPG](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-07.svg)
5. Run it. The tool trims the photo to land as close to the number you typed as possible and downloads the result automatically. ![the finished file downloading, with its reported size](/blog/how-to-resize-a-photo-to-an-exact-kb-size-shot-08.svg)
